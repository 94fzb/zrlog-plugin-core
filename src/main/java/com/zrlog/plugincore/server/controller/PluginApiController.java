...
public class PluginApiController extends Controller {
    ...
    public void start() throws IOException {
        ...
        if (RunConstants.runType != RunType.DEV) {
            ...
            PluginUtil.loadPlugin(new File(PluginConfig.getInstance().getPluginFileByName(pluginName)), PluginConfig.getInstance().getPluginVOByName(pluginName).getPlugin().getId());
